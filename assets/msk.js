...
//## Provides a lookup for publications in Synapse and automatically populates the publication form 
// with a DOI, URL, and formatted citation.
function getSynapseData(){
...
} //End function getSynapseData()

// Loads the SynapseID lookup js on Modal Forms (needed b/c modals are dynamically loaded on click after page JS has run)
$('#addEntityFormModal').on('show.bs.modal', function () {
  getSynapseData();
});

// Load the Synapseid lookup js on non-modal pages - needed when directly editing or updating cited publications.
$( getSynapseData );