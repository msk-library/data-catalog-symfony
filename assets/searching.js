...
$('.keyword-breadcrumb.btn').hover(
  function () {
    $(this).attr('class', 'keyword-breadcrumb btn btn-sm btn-outline-danger rounded-pill');
    $(this).append('<i class="icon-remove-sign"></i>');
  },
  function () {
    $(this).attr('class', 'keyword-breadcrumb btn btn-sm btn-outline-secondary rounded-pill');
...
$('.facetBreadcrumb.btn').on({
  mouseover: function () {
    $(this).attr('class', 'facetBreadcrumb btn btn-sm btn-outline-danger rounded-pill');
    $(this).append('<i class="icon-remove-sign"></i>');
  },
  mouseout: function () {
    $(this).attr('class', 'facetBreadcrumb btn btn-sm btn-outline-secondary rounded-pill');
    $(this).children('.icon-remove-sign').remove();
  }
});
 ...
 */
var keywordForm = $('#search-form');
var keywordInput = $('#search-input');
